                ...
                <div className="p-4 border-t border-slate-900 space-y-2">
                    <div className="flex items-center gap-3 p-2.5 bg-slate-900/60 rounded-xl border border-slate-800">
                        <UserButton
                            appearance={{
                                elements: {
                                    avatarBox: "w-9 h-9 rounded-lg border border-amber-400/30"
                                }
                            }}
                        />
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold text-rose-400 hover:text-rose-300 bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/20 transition cursor-pointer"
                    >
